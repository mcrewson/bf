...
package blackflag.data.persist.source;
    ...
    implements SmartDataSource, DisposableBean
{
     ...
     */
    public CloseSuppressingDataSource() {
    }

    /**
     * Create a new CloseSuppressingDataSource with the given standard
     ...
     */
    public CloseSuppressingDataSource(String url, String username, String password, boolean suppressClose) {
     ...
     * @see java.sql.DriverManager#getConnection(String, String, String)
     */
    public CloseSuppressingDataSource(String url, boolean suppressClose) {
        super(url);
        this.suppressClose = suppressClose;
    }

    /**
     * Create a new CloseSuppressingDataSource with a given Connection.
     ...
     */
    public CloseSuppressingDataSource(Connection target, boolean suppressClose) {
        ...
        synchronized (this.connectionMonitor) {
            ...
            if (this.connection.isClosed()) {
                throw new SQLException(
                        "Connection was closed in CloseSuppressingDataSource. Check that user code checks " +
    ...
    public Connection getConnection(String username, String password) throws SQLException {
        if (ObjectUtils.nullSafeEquals(username, getUsername()) &&
            ...
            throw new SQLException("CloseSuppressingDataSource does not support custom username and password");
        }
    }
